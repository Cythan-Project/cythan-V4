    ...
    fn inner(codeblock: MirCodeBlock, reads: &HashSet<u32>) -> MirCodeBlock {
        ...
        for i in codeblock {
            match i {
                ...
                crate::Mir::Continue => newblock.push(crate::Mir::Continue),
                crate::Mir::Stop => newblock.push(crate::Mir::Stop),
                ...
                crate::Mir::Match(a, b) => {
                    newblock.push(crate::Mir::Match(
                        a,
                        b.into_iter().map(|(a, b)| (inner(a, reads), b)).collect(),
                    ));
                }
            }
        }
